...
def register_subparser(subparsers):
    ...
    p.add_argument("-o", required=True, help="Output FASTA file")
    p.set_defaults(func=_dispatch("jsrc.seq.rename"))
    ...
    p.set_defaults(func=_dispatch("jsrc.seq.promoter"))
    ...
    p.add_argument("--json", action="store_true", help="Print JSON")
    p.set_defaults(func=_dispatch("jsrc.seq.codon"))
    ...
    p.add_argument("--json", action="store_true", help="Print JSON")
    p.set_defaults(func=_dispatch("jsrc.seq.window"))
